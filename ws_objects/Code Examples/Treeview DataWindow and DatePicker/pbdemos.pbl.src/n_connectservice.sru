...
Choose Case is_connectfrom
	...
	Case IS_USE_INIFILE						/*  Populate Database Connection from INI file  */
		string ls_inifile = "treeviewdwandmenu.ini"
		...
		as_dbparm		= ProfileString ( ls_inifile, "Database", "DBParm", "ConnectString='DSN=PB Demo DB V2017R2 Unicode;UID=dba;PWD=sql'")
	...
	Case IS_USE_REGISTRY						/*  Populate Database Connection from Registry  */
		...
		If RegistryGet ( ls_registrykey, "DBParm", 		RegString!, as_dbparm ) <> 1 Then
			RegistrySet ( ls_registrykey, "DBParm", 		RegString!, "ConnectString='DSN=PB Demo DB V2017R2 Unicode;UID=dba;PWD=sql'" )
	...
	Case IS_USE_SCRIPT							/*  Populate Database Connection from Script  */
		...
		as_logpass		= ""
		as_server		= ""
		as_dbparm		= "ConnectString='DSN=PB Demo DB V2017R2 Unicode;UID=dba;PWD=sql'"
		as_lock			= ""
		as_autocommit	= "false"
