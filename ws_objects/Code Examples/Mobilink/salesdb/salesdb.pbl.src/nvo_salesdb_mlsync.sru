$PBExportHeader$nvo_salesdb_mlsync.sru
$PBExportComments$Non-visual object that controls dbmlsync
forward
global type nvo_salesdb_mlsync from mlsync
end type
end forward

global type nvo_salesdb_mlsync from mlsync
string publication = "salesapi"
boolean usewindow = true
string progresswindowname = "w_salesdb_syncprogress"
boolean uselogfile = true
string logfilename = "dbmlsync.log"
string logopts = " -v+"
long mlserverversion = 17
string syncregistrykey = "Software\Sybase\PowerBuilder\17.0\salesdb"
string datasource = "SalesDB_Remote"
string dbuser = "dba"
string dbpass = "sql"
end type
global nvo_salesdb_mlsync nvo_salesdb_mlsync

type variables
w_salesdb_syncprogress		i_syncwindow
...
on nvo_salesdb_mlsync.create
call super::create
TriggerEvent( this, "constructor" )
end on

on nvo_salesdb_mlsync.destroy
